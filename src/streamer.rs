...
use crate::packet::{self, PacketBatch, PacketBatchRecycler, PACKETS_PER_BATCH};
use crate::sendmmsg::{batch_send, SendPktsError};
use crate::socket::SocketAddrSpace;
...
mod test {
    ...
    use super::*;
    use crate::packet::{Packet, PacketBatch, PACKET_DATA_SIZE};
