...
use crate::nonblocking::quic::ConnectionPeerType;
use crate::quic::StreamStats;
...
pub mod test {
    ...
    use super::*;
    use crate::nonblocking::quic::DEFAULT_MAX_STREAMS_PER_MS;
    use crate::nonblocking::stream_throttle::STREAM_LOAD_EMA_INTERVAL_MS;
